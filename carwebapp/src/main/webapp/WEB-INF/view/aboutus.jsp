...
<script src="webapp/resources/js/jquery-1.7.min.js"></script>
			...
			<nav>
				<ul class="menu">
					<li><a href="index.html" class="home"><img
							src="resources/images/home.jpg" alt=""></a></li>
 		...
 		<section id="content">
			<div class="sub-page">
				<div class="sub-page-left">
					...
					<div class="wrap">
						<img src="resources/images/page2-img1.jpg" alt="" class="img-indent">
						<div class="extra-wrap">
							<p class="text-2 p2">sit amet consetetur sadipscing</p>
							<p class="upper">Consetetur sadipscing elitr, sed diam nonumy
					...
					<p class="upper">voluptua. At vero eos et accusam et justo duo
						dolores et ea rebum. Stet clita kasd gubergren, no sea takimata
						sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit.</p>
					<div class="box-4">
						<div>
							<img src="resources/images/logo.png" alt=""> <a href="#"
								class="link">James Willis</a>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
								sed do eiusmod tempor.</p>
						</div>
						<div>
							<img src="resources/images/page2-img3.jpg" alt=""> <a href="#"
								class="link">Samuel Johnson</a>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy
								hendrerit mauris.</p>
						</div>
						<div class="last">
							<img src="resources/images/page2-img4.jpg" alt=""> <a href="#"
								class="link">Bradley Riley</a>
							<p>Aenean nec eros. Vestibulum ante ipsum primis in faucibus
								orci luctus et ultrices.</p>
						</div>
					</div>
				...
				<div class="sub-page-right">
					<div class="shadow bot-1">
						...
						<p class="upper">Lorem ipsum dolor sit amet, consetetur
					...
					<!-- <div class="box-5">
						...
						<img src="resources/images/page2-img5.jpg" alt="">
						<p class="upper">Aenean nec er Vestibulum ante ipsum primis in
							faucibus:</p>
						<ul class="list-1">
